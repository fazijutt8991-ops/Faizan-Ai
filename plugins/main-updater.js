...
cmd({
    ...
    try {
        ...
        const { data: commitData } = await axios.get("https://github.com/Faizan-MD-BOTZ/Faizan-Ai/tree/main");
        ...
        const { data: zipData } = await axios.get("https://github.com/Faizan-MD-BOTZ/Faizan-Ai/tree/main", { responseType: "arraybuffer" });
